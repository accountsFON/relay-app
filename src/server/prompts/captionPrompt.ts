  ...
  "posts": [
    {
      "postNumber": 1,
      "date": "YYYY-MM-DD",
      "caption": "The caption body text with line breaks as \\n. Body only — do NOT include a CTA, contact info, or hashtags.",
...
TASK: Write the caption body for one publish-ready post per plan date using Client Brief + Supporting Facts. Body only — the system appends the CTA after generation.
